...
<?php
	...
	if (isset($_POST['submit']))
	{
	    if ($_SERVER["REQUEST_METHOD"] == "POST") {
	        ...
	        $dbPassword = "Pujari@123"; // Replace with your database password
	        ...
	        else 
	        {
	            ...
	            if ($result && mysqli_num_rows($result) > 0)
	            {
	                ...
	                $sql = "INSERT INTO projects (project_title, project_description, project_file, project_skills, project_price, project_days, client_id) VALUES ('$pr_title', '$pr_about', '$targetFilePath', '$pr_skills', '$pr_price', '$pr_days', '$clientId')";
